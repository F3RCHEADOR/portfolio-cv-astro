...
const ThemeToggleButton = () => {
  ...
  return (
    <button
      id="toggle-theme"
      type="button"
      className="fixed top-2.5 right-2 border-2 cursor-pointer p-1 bg-gray-200 dark:bg-gray-500 rounded-full"
    ...
    >
      ...
      <svg
        ...
        strokeWidth="1.5"
        stroke="currentColor"
        className={`size-6 ${isDark ? "hidden" : ""}`} // Mostrar cuando es claro
      >
        <path
          strokeLinecap="round"
